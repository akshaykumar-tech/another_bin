...
async def main() -> None:
    ...
    if GODMODE_ENABLED:
        god_log(
            ...
            f"notional=${NOTIONAL} SL={SL_PCT}% TP={TP_PCT}% max_open=unlimited"
        )
